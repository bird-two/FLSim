...
[5] https://github.com/TsingZ0/PFL-Non-IID/issues/28
'''
...
def build_distribution(data_path='../flsim/data/partitionfiles/inuse/', dtype='mnist', num_users=16, way='iid-b', alpha=10):
    ...
    net_dataidx_map = DataPartitioner.read_net_dataidx_map(data_path=data_path, dtype=dtype, partition=partition, balance=balance, n_nets=num_users, alpha=alpha)
...
class DataPartitioner():
    ...
    def read_net_dataidx_map(cls, data_path='./datasets/distribution/', dtype="mnist", partition="iid", balance='b', n_nets=16, alpha=10):
        ...
        elif partition in ['dir']:
            filepath = "{}/{}_N[{}]_{}[{}].txt".format(data_path, dtype, n_nets, partition, alpha)
...
def main():
    ...
    a = DataPartitioner(dtype, data_path)
...
if __name__ == '__main__':
    ...
    # main()
    net = build_distribution(data_path='../flsim/data/partitionfiles/inuse/', dtype='mnist', num_users=10, way='dir-u', alpha=1.0)
